...
{
    public class ContactUsMessagesRepository : RepositoryBase, IRepositoryBase<DAL.FlipCardGameEntities>
    {
        ...
        public DAL.ContactUs ToDALModel(RoyaMVC_EN.AccountManagement.RoyaContactUsModel royaModel) {
            ...
            res.MessageDateTime = royaModel.MessageDateTimeGregorian;
        ...
        public RoyaMVC_EN.AccountManagement.RoyaContactUsModel ToRoyaModel(DAL.ContactUs model) {
            ...
            res.IsRead = model.IsRead;
            res.MessageBody = model.MessageBody;
            res.MessageDateTimeGregorian = model.MessageDateTime;
